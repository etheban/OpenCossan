 ...
 */
FANN_EXTERNAL void fann_error(struct fann_error *errdat, const enum fann_errno_enum errno_f, ...);


/* INTERNAL FUNCTION
   Initialize an error data strcuture
 */
FANN_EXTERNAL void fann_init_error_data(struct fann_error *errdat);
