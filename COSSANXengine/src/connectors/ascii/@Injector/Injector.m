classdef Injector
    ...
    methods (Access= private)
        ...
        function Xinj = createByScan(Xinj)
            ...
            OpenCossan.cossanDisp(['[COSSAN-X.Injector.createByScan] File to be scanned: ' Scanfullname],2)
            ...
            fclose(Nfid);
            OpenCossan.cossanDisp(['[COSSAN-X.Injector.createByScan] Close File to be scanned: ' Scanfullname],2)
            ...
            OpenCossan.cossanDisp('[COSSAN-X.Injector.createByScan] Identifier identified correctly',4)
        end   
