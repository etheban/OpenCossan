classdef OpenCossan < handle
    ...
    properties (Constant,Hidden)
        ...
        CtutorialsPathFolders={...
            ...
            fullfile('examples','Tutorials','Building'), ...
            ...
            fullfile('examples','Tutorials','CarModel'), ...
        ...
        % Predefined path for mex files
        CdocsPathFolders={fullfile('docs'),fullfile('docs','html')}
                ...
                switch lower(varargin{k})
                    case {'scossanroot','scossanpath'}
                        assert (isdir(varargin{k+1}), ...
                            'openCOSSAN:OpenCossan','please provide a valid directory name after Scossanpath')
                        Sroot=varargin{k+1};
                    ...
                    case {'sexternalpath'} %  DONE
                        assert(isdir(varargin{k+1}), ...
                            'openCOSSAN:OpenCossan','please provide a valid directory name for the externalpath')
                        Xobj.SexternalPath=varargin{k+1};
                    case {'smcrpath'} %DONE
                        assert(isdir(varargin{k+1}), ...
                            'openCOSSAN:OpenCossan','please provide a valid directory name for the MatlabCompilerRuntime')
                        Xobj.SmcrPath=varargin{k+1};
                    case {'smatlabpath'}  %  DONE
                        assert(isdir(varargin{k+1}), ...
                            'openCOSSAN:OpenCossan','please provide a valid directory name for the Matlab installation')
                        Xobj.SmatlabPath=varargin{k+1};
                    case {'smatlabdatabasepath'} %  DONE
                        assert(isdir(varargin{k+1}), ...
                            'openCOSSAN:OpenCossan','please provide a valid directory name for the Engine Database Path')
