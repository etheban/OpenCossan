...
warning('OpenCossan:Sensitivity',...
    ...
    OpenCossan.setLaptime('Sdescription','[Sensitivity:sobolIndices] Start sensitivity analysis')
...
OpenCossan.setLaptime('Sdescription','[Sensitivity:sobolIndices] Stop sensitivity analysis')
