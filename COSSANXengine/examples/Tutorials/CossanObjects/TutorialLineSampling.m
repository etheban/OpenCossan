...
Xls1=LineSampling('Nlines',10,'Xgradient',Xgrad,'Vset',[0.1 0.5 1 3]);
Xls2=LineSampling('Nlines',10,'Xgradient',Xlocal,'Vset',[0.1 0.5 1 3]);
Xls3=LineSampling('Nlines',10,'Xgradient',XlocalMC,'Vset',[0.1 0.5 1 3]);
%%
[Xpf1,Xout1]=Xpm.computeFailureProbability(Xls1);
[Xpf2,Xout2]=Xpm.computeFailureProbability(Xls2);
[Xpf3,Xout3]=Xpm.computeFailureProbability(Xls3);
...
Xout2.plotLines('Stitle','LineSampling + LocalFiniteDifference');
Xout3.plotLines('Stitle','LineSampling + LocalMonteCarlo');
