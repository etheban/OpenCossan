...
% 
% See Also: http://cossan.cfd.liv.ac.uk/wiki/index.php/@CossanX
%
% $Copyright~1993-2011,~COSSAN~Working~Group,~University~of~Innsbruck,~Austria$
% $Author: Edoardo-Patelli$ 

%% ATTENTION
% the command OpenCossan does not call the display of the object CossanX but the
% constructor. This means that calling CossanX without argument the CossanX
...
global OPENCOSSAN
assert(~isempty(OPENCOSSAN),'openCOSSAN:TutorialCossanX','COSSANengine toolbox not initialised')
...
assert(all(Vsamples1==Vsamples2),'Tutotiral:CossanX','RandomNumber Generator not reinitialized')
