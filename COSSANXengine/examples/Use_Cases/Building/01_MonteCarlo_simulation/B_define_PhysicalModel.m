...
Xc= Connector('Stype','abaqus',...   % FE solver used
    'Smaininputfile','Building.inp',... % main input file
    'Sworkingdirectory','./', ...    % working directory
    'SpostExecutionCommand','/usr/site/bin/abq673 cae noGUI=generate_report.py',...    % shell command for calling Python script
...
%Xjm = JobManagerInterface('Stype','gridengine_matlab','Squeue','pizzas64.q','Shostname','c810-cl21.uibk.ac.at');
%Xjob = JobManager('Sdescription','test job','Xjobmanagerinterface',Xjm,'Nconcurrent',3);
%Xeval = Evaluator('Xconnector',Xc,'XJobManager',Xjob,'LremoteInjectExtract',true);
