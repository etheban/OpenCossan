classdef UTTutorialBridgeModel < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 6;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialBridgeModel';                                       %Enter the name of the script to be tested.
        VName       = {'NominalDisplacement'};                                     %Enter Variable Names into cell array
        Expected    = {[0.0040523]};                                     %Enter the expected results into cell array
