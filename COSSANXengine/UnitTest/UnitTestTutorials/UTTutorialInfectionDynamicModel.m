classdef UTTutorialInfectionDynamicModel < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 13;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialInfectionDynamicModel';                                       %Enter the name of the script to be tested.
        VName       = {'min(VY)'};                                     %Enter Variable Names into cell array
        Expected    = {[1.6894]};                                     %Enter the expected results into cell array
