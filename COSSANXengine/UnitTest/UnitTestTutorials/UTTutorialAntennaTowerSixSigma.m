classdef UTTutorialAntennaTowerSixSigma < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 1;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialAntennaTowerSixSigma';                                       %Enter the name of the script to be tested.
        VName       = {'Xoptimum.XobjectiveFunction.Mdata(end)'};                                     %Enter Variable Names into cell array
        Expected    = {[4000]};                                     %Enter the expected results into cell array
        Tolerance   = {[10]};                                     %Enter the given tolerances into cell array
