classdef UTTutorialBridgeModelUncertaintyQuantification < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 7;                                         %Enter Test Number
        PreTest     = {'TutorialBridgeModel'};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialBridgeModelUncertaintyQuantification';                                       %Enter the name of the script to be tested.
        VName       = {'Mstatistics(3)'};                                     %Enter Variable Names into cell array
        Expected    = {[0.00420537]};                                     %Enter the expected results into cell array
        Tolerance   = {[0.000001]};                                     %Enter the given tolerances into cell array
