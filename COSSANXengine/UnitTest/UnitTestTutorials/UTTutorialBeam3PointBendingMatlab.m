classdef UTTutorialBeam3PointBendingMatlab < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 4;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialBeam3PointBendingMatlab';                                       %Enter the name of the script to be tested.
        VName       = {'Xpf'};                                     %Enter Variable Names into cell array
        Expected    = {[0.0575]};                                     %Enter the expected results into cell array
        Tolerance   = {[5E-4]};                                     %Enter the given tolerances into cell array
